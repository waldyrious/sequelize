...
class BelongsToMany extends Association {
   ...
   * If a list of instances is passed, the function returns true if _all_ instances are associated.
   *
   ...
   * It will not un-associate any already associated instance that may be missing from `newInstances`.
   *
   * @param {Model} sourceInstance source instance to associate new instances with

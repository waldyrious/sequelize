...
class QueryInterface {
   ...
   * @param {string} [options.encoding] Database default character set, Postgres only
   * @param {string} [options.ctype] Database character classification, Postgres only
   * @param {string} [options.template] The name of the template from which to create the new database, Postgres only
   *
   * @returns {Promise}
   */
   ...
   *     schema: 'public',    // default: public, Postgres only.
